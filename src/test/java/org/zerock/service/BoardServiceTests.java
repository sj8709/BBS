...
public class BoardServiceTests {
	 ...
	 * 
	 * // service.getList().forEach(board -> log.info(board)); service.getList(new
	 * Criteria(2, 10)).forEach(board -> log.info(board)); }
	 * 
	 ...
	 * 
	 * // 게시물 번호의 존재 여부를 확인하고 테스트할 것 log.info("REMOVE RESULT: " +
	 * service.remove(2L));
	 * 
	 * }
	 * 
